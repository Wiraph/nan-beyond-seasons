...
const en: Dictionary = {
  ...
  "chat.placeholder": "Ask Nong Krasip about events or places in Nan…",
  "chat.tabSport": "Travel & events", "chat.tabHelp": "How to use", "chat.botTagline": "Whispering where Nan is most fun",
  ...
  "footer.ai": "Nong Krasip", "footer.assistance": "Assistance", "footer.calendar": "Calendar", "footer.description": "Ruedu Muan Nan keeps sports festivals, race weekends, and community updates together.", "footer.fax": "Fax", "footer.home": "Home", "footer.links": "Quick links", "footer.organization": "Nan Provincial Sports", "footer.passport": "Passport", "footer.phone": "Phone", "footer.rewards": "Rewards", "footer.safetyNote": "Check official event notices before travelling or competing.", "footer.safetyTitle": "Race-day note",
  ...
  // Organizer overview
  "org.title": "Run your event workspace", "org.intro": "All event data comes from the published Ruedu Muan Nan sport schedule. Manage events, check-ins, and their status from here.", "org.createCta": "Create new event",
...
const th: Dictionary = {
  ...
  "chat.placeholder": "ถามน้องกระซิบเรื่องงานกีฬา หรือที่เที่ยวน่าน…",
  "chat.tabSport": "เที่ยว & งานกีฬา", "chat.tabHelp": "วิธีใช้งาน", "chat.botTagline": "กระซิบบอกว่าน่านม่วนตรงไหน",
  ...
  "footer.ai": "น้องกระซิบ", "footer.assistance": "ติดต่อสอบถาม", "footer.calendar": "ปฏิทิน", "footer.description": "ฤดูม่วนน่าน รวมงานกีฬา แผนรอบสนามแข่ง และความเคลื่อนไหวของชุมชนไว้ด้วยกัน", "footer.home": "หน้าแรก", "footer.links": "ลิงก์ด่วน", "footer.passport": "พาสปอร์ต", "footer.rewards": "รางวัล", "footer.phone": "โทรศัพท์", "footer.safetyNote": "ตรวจสอบประกาศของผู้จัดก่อนเดินทางหรือร่วมแข่งขัน", "footer.safetyTitle": "หมายเหตุวันแข่ง",
  "plan.aiFallback": "แผนแนะนำจากข้อมูลในระบบ", "sport.aiPlan": "แผนรอบสนามแข่งจาก AI",
  ...
  // Organizer overview
  "org.title": "จัดการพื้นที่งานของคุณ", "org.intro": "ข้อมูลงานทั้งหมดมาจากปฏิทินกีฬาฤดูม่วนน่าน จัดการงาน การเช็กอิน และติดตามสถานะได้จากที่นี่", "org.createCta": "สร้างงานใหม่",
  ...
  // Admin overview
  "adm.title": "ภาพรวมการดำเนินงาน", "adm.intro": "ภาพรวมตัวชี้วัดการดำเนินงานจากงานกีฬาฤดูม่วนน่านทั้งหมด", "adm.metric.allRecords": "งานทั้งหมด", "adm.metric.competition": "โหมดแข่งขัน", "adm.metric.spectator": "โหมดเข้าชม", "adm.review.title": "รายการตรวจสอบ", "adm.review.sub": "งานที่กำลังจะมาถึงและล่าสุดจากปฏิทินที่ใช้ร่วมกัน", "adm.reviewDemo": "ตัวอย่างการตรวจสอบ",
  // Admin events
